...
export function loadSellTokens(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 4185553464) { throw Error('Invalid prefix'); }
    let _tokenAmount = sc_0.loadIntBig(257);
    let _from = sc_0.loadAddress();
    return { $$type: 'SellTokens' as const, tokenAmount: _tokenAmount, from: _from };
}
...
const JettonWalletImp_types: ABIType[] = [
    ...
    {"name":"SellTokens","header":4185553464,"fields":[{"name":"tokenAmount","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"from","type":{"kind":"simple","type":"address","optional":false}}]},
